...
IMPLEMENT_DYNCREATE(dynamic_html_dlg, CDHtmlDialog)


dynamic_html_dlg::dynamic_html_dlg():
	CDHtmlDialog()
{
}

	dynamic_html_dlg::dynamic_html_dlg(UINT nIDTemplate, UINT nHtmlResID, CWnd *pParentWnd) 
		: CDHtmlDialog( nIDTemplate, nHtmlResID, pParentWnd )
{

}
dynamic_html_dlg::dynamic_html_dlg(LPCTSTR lpszTemplateName, LPCTSTR szHtmlResID, CWnd *pParentWnd)
...
void dynamic_html_dlg::DoDataExchange(CDataExchange* pDX)
{
	CDHtmlDialog::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(dynamic_html_dlg, CDHtmlDialog)
	ON_WM_DESTROY()
END_MESSAGE_MAP()
...
#ifdef _DEBUG
void dynamic_html_dlg::AssertValid() const
{
	CDHtmlDialog::AssertValid();
}

void dynamic_html_dlg::Dump(CDumpContext& dc) const
{
	CDHtmlDialog::Dump(dc);
}
#endif //_DEBUG
...
void dynamic_html_dlg::Initialize(void)
{
...
BOOL dynamic_html_dlg::PreTranslateMessage(MSG* pMsg)
{
	//ban function keys
	if(
		(
	...
	{
		OutputDebugStringA("Function key ignored\r\n");
		return true;
	}
	...
	{
		//Ctrl-N
		OutputDebugStringA("Ctrl-N ignored\r\n");
		return true;
	}
	//ban printing
	...
	{
		//Ctrl-P
		OutputDebugStringA("Ctrl-P ignored\r\n");
		return true;
	}
	...
	{
		//Ctrl-D
		OutputDebugStringA("Ctrl-D ignored\r\n");
		return true;
	}
	...
	{
		//Atl-Left
		OutputDebugStringA("Atl-Left ignored\r\n");
		return true;
	}
	...
	{
		//Atl-Right
		OutputDebugStringA("Atl-Right ignored\r\n");
		return true;
	}
...
void dynamic_html_dlg::GotoUrl(LPCTSTR pszUrl)
{
	CString strPath,str;
...
void dynamic_html_dlg::DDX_DHtml_ElementText(CDataExchange* pDX, LPCTSTR szId, DISPID dispid, CString& value)
{
	DDX_DHtml_ElementText(szId, dispid, value, pDX->m_bSaveAndValidate);
}

void dynamic_html_dlg::DDX_DHtml_ElementText(CDataExchange* pDX, LPCTSTR szId, DISPID dispid, short& value)
{
	DDX_DHtml_ElementText(szId, dispid, value, pDX->m_bSaveAndValidate);
}

void dynamic_html_dlg::DDX_DHtml_ElementText(CDataExchange* pDX, LPCTSTR szId, DISPID dispid, int& value)
{
	DDX_DHtml_ElementText(szId, dispid, value, pDX->m_bSaveAndValidate);
}

void dynamic_html_dlg::DDX_DHtml_ElementText(CDataExchange* pDX, LPCTSTR szId, DISPID dispid, long& value)
{
	DDX_DHtml_ElementText(szId, dispid, value, pDX->m_bSaveAndValidate);
}

void dynamic_html_dlg::DDX_DHtml_ElementText(CDataExchange* pDX, LPCTSTR szId, DISPID dispid, DWORD& value)
{
	DDX_DHtml_ElementText(szId, dispid, value, pDX->m_bSaveAndValidate);
}

void dynamic_html_dlg::DDX_DHtml_ElementText(CDataExchange* pDX, LPCTSTR szId, DISPID dispid, float& value)
{
	DDX_DHtml_ElementText(szId, dispid, value, pDX->m_bSaveAndValidate);
}

void dynamic_html_dlg::DDX_DHtml_ElementText(CDataExchange* pDX, LPCTSTR szId, DISPID dispid, double& value)
{
	DDX_DHtml_ElementText(szId, dispid, value, pDX->m_bSaveAndValidate);
}

void dynamic_html_dlg::DDX_DHtml_CheckBox(CDataExchange* pDX, LPCTSTR szId, int& value)
{
	DDX_DHtml_CheckBox(szId, value, pDX->m_bSaveAndValidate);
}

void dynamic_html_dlg::DDX_DHtml_Radio(CDataExchange* pDX, LPCTSTR szId, long& value)
{
	DDX_DHtml_Radio(szId, value, pDX->m_bSaveAndValidate);
}

void dynamic_html_dlg::DDX_DHtml_SelectValue(CDataExchange* pDX, LPCTSTR szId, CString& value)
{
	DDX_DHtml_SelectValue(szId, value, pDX->m_bSaveAndValidate);
}

void dynamic_html_dlg::DDX_DHtml_SelectString(CDataExchange* pDX, LPCTSTR szId, CString& value)
{
	DDX_DHtml_SelectString(szId, value, pDX->m_bSaveAndValidate);
}

void dynamic_html_dlg::DDX_DHtml_SelectIndex(CDataExchange* pDX, LPCTSTR szId, long& value)
{
	DDX_DHtml_SelectIndex(szId, value, pDX->m_bSaveAndValidate);
}

void dynamic_html_dlg::DDX_DHtml_AxControl(CDataExchange *pDX, LPCTSTR szId, DISPID dispid, VARIANT& var)
{
	DDX_DHtml_AxControl(szId, dispid, var, pDX->m_bSaveAndValidate);
}

void dynamic_html_dlg::DDX_DHtml_AxControl(CDataExchange *pDX, LPCTSTR szId, LPCTSTR szPropName, VARIANT& var)
{
	DDX_DHtml_AxControl(szId, szPropName, var, pDX->m_bSaveAndValidate);
}

void dynamic_html_dlg::DDX_DHtml_ElementText(LPCTSTR szId, DISPID dispid, CString& value, BOOL bSave)
{
	CComPtr<IHTMLDocument2> sphtmlDoc;
	CDHtmlDialog::GetDHtmlDocument(&sphtmlDoc);
	if (sphtmlDoc == NULL)
		return;
...
void dynamic_html_dlg::DDX_DHtml_ElementText(LPCTSTR szId, DISPID dispid, short& value, BOOL bSave)
{
	if (bSave)
...
void dynamic_html_dlg::DDX_DHtml_ElementText(LPCTSTR szId, DISPID dispid, int& value, BOOL bSave)
{
	if (bSave)
...
void dynamic_html_dlg::DDX_DHtml_ElementText(LPCTSTR szId, DISPID dispid, long& value, BOOL bSave)
{
	if (bSave)
...
void dynamic_html_dlg::DDX_DHtml_ElementText(LPCTSTR szId, DISPID dispid, DWORD& value, BOOL bSave)
{
	if (bSave)
...
void dynamic_html_dlg::DDX_DHtml_ElementText(LPCTSTR szId, DISPID dispid, float& value, BOOL bSave)
{
	DDX_DHtml_ElementTextFloatFormat(szId, dispid, &value, value, FLT_DIG, bSave);
}

void dynamic_html_dlg::DDX_DHtml_ElementText(LPCTSTR szId, DISPID dispid, double& value, BOOL bSave)
{
...
void dynamic_html_dlg::DDX_DHtml_CheckBox(LPCTSTR szId, int& value, BOOL bSave)
{
	COleVariant var;
...
void dynamic_html_dlg::DDX_DHtml_Radio(LPCTSTR szId, long& value, BOOL bSave)
{
	COleVariant var;
	...
	hr = get_element_from_id(szId, &spdispCollection, &bIsCollection);
...
void dynamic_html_dlg::DDX_DHtml_SelectValue(LPCTSTR szId, CString& value, BOOL bSave)
{
	CComPtr<IHTMLDocument2> sphtmlDoc;
	GetDHtmlDocument(&sphtmlDoc);
	if (sphtmlDoc == NULL)
...
void dynamic_html_dlg::DDX_DHtml_SelectString(LPCTSTR szId, CString& value, BOOL bSave)
{
	CComPtr<IHTMLDocument2> sphtmlDoc;
	GetDHtmlDocument(&sphtmlDoc);
	if (sphtmlDoc == NULL)
...
//void dynamic_html_dlg::SetSilent(BOOL bNewValue)
//{
//	static BYTE parms[] =
//		VTS_BOOL;
...
void dynamic_html_dlg::DDX_DHtml_SelectIndex(LPCTSTR szId, long& value, BOOL bSave)
{
	CComPtr<IHTMLDocument2> sphtmlDoc;
	GetDHtmlDocument(&sphtmlDoc);
	if (sphtmlDoc == NULL)
...
void dynamic_html_dlg::DDX_DHtml_AxControl(LPCTSTR szId, DISPID dispid, VARIANT& var, BOOL bSave)
{
	if (bSave)
...
void dynamic_html_dlg::DDX_DHtml_AxControl(LPCTSTR szId, LPCTSTR szPropName, VARIANT& var, BOOL bSave)
{
	if (bSave)
...
void dynamic_html_dlg::OnDDXError(LPCTSTR szId, UINT nIDPrompt, BOOL /*bSave*/)
{
...
void __cdecl dynamic_html_dlg::DDX_DHtml_ElementTextWithFormat(LPCTSTR szId,
...
void dynamic_html_dlg::DDX_DHtml_ElementTextFloatFormat(LPCTSTR szId,
...
BOOL dynamic_html_dlg::_AfxSimpleScanf(LPCTSTR lpszText,
...
BOOL dynamic_html_dlg::_AfxSimpleFloatParse(LPCTSTR lpszText, double& d)
{
	ATLASSERT(lpszText != NULL);
	while (*lpszText == ' ' || *lpszText == '\t')
		lpszText++;
...
long dynamic_html_dlg::Select_FindString(IHTMLSelectElement *pSelect, BSTR bstr, BOOL /*fExact*/)
{
	long lIndexFound = -1;
	...
	for (varIndex.lVal=0; varIndex.lVal<lCount; varIndex.lVal++)
	{
		...
		if (spdispOption)
		{
			...
			if (spOption)
			{
				CComBSTR bstrText;
				spOption->get_text(&bstrText);
				if (bstrText && !_wcsicmp(bstrText, bstr))
				{
					// we found it
...
void dynamic_html_dlg::SetFocusToElement(LPCTSTR szId)
{
...
HRESULT dynamic_html_dlg::GetControlDispatch(LPCTSTR szId, IDispatch **ppdisp)
{
	HRESULT hr = S_OK;
	CComPtr<IDispatch> spdispElem;

	hr = get_element_from_id(szId, &spdispElem);
...
VARIANT dynamic_html_dlg::GetControlProperty(IDispatch *pdispControl, DISPID dispid)
{
	VARIANT varRet;
	varRet.vt = VT_EMPTY;
	if (pdispControl)
...
VARIANT dynamic_html_dlg::GetControlProperty(LPCTSTR szId, DISPID dispid)
{
	CComPtr<IDispatch> spdispElem;
...
VARIANT dynamic_html_dlg::GetControlProperty(LPCTSTR szId, LPCTSTR szPropName)
{
...
void dynamic_html_dlg::SetControlProperty(IDispatch *pdispControl, DISPID dispid, VARIANT *pVar)
{
...
void dynamic_html_dlg::SetControlProperty(LPCTSTR szElementId, DISPID dispid, VARIANT *pVar)
{
	CComPtr<IDispatch> spdispElem;
...
void dynamic_html_dlg::SetControlProperty(LPCTSTR szElementId, LPCTSTR szPropName, VARIANT *pVar)
{
	CComPtr<IDispatch> spdispElem;
	GetControlDispatch(szElementId, &spdispElem);
	if (!spdispElem)
...
HRESULT dynamic_html_dlg::GetEvent(IHTMLEventObj **ppEventObj)
{
...
HRESULT dynamic_html_dlg::ConnectDHtmlEvents(IUnknown *punkDoc)
{
	return ConnectToConnectionPoint(punkDoc, __uuidof(HTMLDocumentEvents), &m_dwDHtmlEventSinkCookie);
}

void dynamic_html_dlg::DisconnectDHtmlEvents()
{
	CComPtr<IHTMLDocument2> sphtmlDoc;
	GetDHtmlDocument(&sphtmlDoc);
...
HRESULT dynamic_html_dlg::ConnectDHtmlElementEvents(DWORD_PTR dwThunkOffset /*= 0*/)
{
	HRESULT hr = S_OK;
	...
	for (int i=0; pEventMap[i].nType != DHTMLEVENTMAPENTRY_END; i++)
	{
		if (pEventMap[i].nType==DHTMLEVENTMAPENTRY_ELEMENT)
		{
			...
			get_element_from_id(pEventMap[i].szName, &spdispElement);
			if (spdispElement)
			{
...
void dynamic_html_dlg::DisconnectDHtmlElementEvents()
{
	const DHtmlEventMapEntry* pEventMap = GetDHtmlEventMap();
...
HRESULT dynamic_html_dlg::get_element_from_id(LPCTSTR szElementId, IDispatch **ppdisp, 
...
HRESULT dynamic_html_dlg::get_element_from_id(LPCTSTR szElementId, IHTMLElement **pphtmlElement)
{
	return GetElementInterface(szElementId, __uuidof(IHTMLElement), (void **) pphtmlElement);
}


BSTR dynamic_html_dlg::GetElementText(LPCTSTR szElementId)
{
	BSTR bstrText = NULL;
	CComPtr<IHTMLElement> sphtmlElem;
	get_element_from_id(szElementId, &sphtmlElem);
	if (sphtmlElem)
		sphtmlElem->get_innerText(&bstrText);
	return bstrText;
}

void dynamic_html_dlg::SetElementText(LPCTSTR szElementId, BSTR bstrText)
{
	CComPtr<IHTMLElement> sphtmlElem;
	get_element_from_id(szElementId, &sphtmlElem);
	if (sphtmlElem)
...
void dynamic_html_dlg::SetElementText(IUnknown *punkElem, BSTR bstrText)
{
	CComPtr<IHTMLElement> sphtmlElem;
...
BSTR dynamic_html_dlg::GetElementHtml(LPCTSTR szElementId)
{
	BSTR bstrText = NULL;
	CComPtr<IHTMLElement> sphtmlElem;
	get_element_from_id(szElementId, &sphtmlElem);
...
void dynamic_html_dlg::SetElementHtml(LPCTSTR szElementId, BSTR bstrText)
{
	CComPtr<IHTMLElement> sphtmlElem;
	get_element_from_id(szElementId, &sphtmlElem);
	if (sphtmlElem)
...
void dynamic_html_dlg::SetElementHtml(IUnknown *punkElem, BSTR bstrText)
{
	CComPtr<IHTMLElement> sphtmlElem;
	punkElem->QueryInterface(__uuidof(IHTMLElement), (void **) &sphtmlElem);
	if (sphtmlElem != NULL)
...
VARIANT dynamic_html_dlg::GetElementProperty(LPCTSTR szElementId, DISPID dispid)
{
	VARIANT varRet;
	CComPtr<IDispatch> spdispElem;
	varRet.vt = VT_EMPTY;
	get_element_from_id(szElementId, &spdispElem);
	if (spdispElem)
	{
		DISPPARAMS dispparamsNoArgs = { NULL, NULL, 0, 0 };
...
void dynamic_html_dlg::SetElementProperty(LPCTSTR szElementId, DISPID dispid, VARIANT *pVar)
{
	CComPtr<IDispatch> spdispElem;
...
HRESULT dynamic_html_dlg::GetElementInterface(LPCTSTR szElementId, REFIID riid, void **ppvObj)
{
	HRESULT hr = E_NOINTERFACE;
	*ppvObj = NULL;
	CComPtr<IDispatch> spdispElem;

	hr = get_element_from_id(szElementId, &spdispElem);

	if (spdispElem)
		hr = spdispElem->QueryInterface(riid, ppvObj);
	return hr;
}
BOOL dynamic_html_dlg::FindSinkForObject(LPCTSTR szName)
{
...
BOOL dynamic_html_dlg::IsSinkedElement(IDispatch *pdispElem)
{
...
void dynamic_html_dlg::OnNavigateComplete(LPDISPATCH pDisp, LPCTSTR szUrl)
{
	CComPtr<IHTMLDocument2> sphtmlDoc;
...
void dynamic_html_dlg::OnDocumentComplete(LPDISPATCH pDisp, LPCTSTR szUrl)
{
	ConnectDHtmlElementEvents((((DWORD_PTR)static_cast< CDHtmlSinkHandler* >(this)) - (DWORD_PTR)this));
	UpdateData(FALSE);
}
void dynamic_html_dlg::OnBeforeNavigate(LPDISPATCH pDisp, LPCTSTR szUrl)
{	
...
void dynamic_html_dlg::OnDestroy()
{
