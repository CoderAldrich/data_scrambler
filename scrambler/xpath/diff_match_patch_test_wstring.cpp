...
class diff_match_patch_test : diff_match_patch<wastring> {
 ...
 public:
  ...
  void testDiffCharsToLines() {
    ...
    assertTrue("diff_charsToLines:", Diff(OP_EQUAL, "a") == Diff(OP_EQUAL, "a"));

    assertEquals("diff_charsToLines:", Diff(OP_EQUAL, "a"), Diff(OP_EQUAL, "a"));

    // Convert chars up to lines.
    Diffs diffs;
    diffs.push_back(Diff(OP_EQUAL, "\1\2\1"));  // ("\u0001\u0002\u0001");
    diffs.push_back(Diff(OP_INSERT, "\2\1\2"));  // ("\u0002\u0001\u0002");
    Lines tmpVector;
    tmpVector.text1 = string_t("alpha\n");
    tmpVector.text2 = string_t("beta\n");
    tmpVector.resize(3);
    ...
    assertEquals("diff_charsToLines:", diffList(Diff(OP_EQUAL, "alpha\nbeta\nalpha\n"), Diff(OP_INSERT, "beta\nalpha\nbeta\n")), diffs);
    ...
    assertEquals("diff_linesToChars: More than 256 (setup).", n + 1, tmpVector.size());
    assertEquals("diff_linesToChars: More than 256 (setup).", n, chars.length());
    diffs = diffList(Diff(OP_DELETE, chars));
    dmp.diff_charsToLines(diffs, tmpVector);
    assertEquals("diff_charsToLines: More than 256.", diffList(Diff(OP_DELETE, tmpVector.text1)), diffs);
  }
  ...
  void testDiffCleanupMerge() {
    ...
    diffs = diffList(Diff(OP_EQUAL, "a"), Diff(OP_DELETE, "b"), Diff(OP_INSERT, "c"));
    dmp.diff_cleanupMerge(diffs);
    assertEquals("diff_cleanupMerge: No change case.", diffList(Diff(OP_EQUAL, "a"), Diff(OP_DELETE, "b"), Diff(OP_INSERT, "c")), diffs);

    diffs = diffList(Diff(OP_EQUAL, "a"), Diff(OP_EQUAL, "b"), Diff(OP_EQUAL, "c"));
    dmp.diff_cleanupMerge(diffs);
    assertEquals("diff_cleanupMerge: Merge equalities.", diffList(Diff(OP_EQUAL, "abc")), diffs);

    diffs = diffList(Diff(OP_DELETE, "a"), Diff(OP_DELETE, "b"), Diff(OP_DELETE, "c"));
    dmp.diff_cleanupMerge(diffs);
    assertEquals("diff_cleanupMerge: Merge deletions.", diffList(Diff(OP_DELETE, "abc")), diffs);

    diffs = diffList(Diff(OP_INSERT, "a"), Diff(OP_INSERT, "b"), Diff(OP_INSERT, "c"));
    dmp.diff_cleanupMerge(diffs);
    assertEquals("diff_cleanupMerge: Merge insertions.", diffList(Diff(OP_INSERT, "abc")), diffs);

    diffs = diffList(Diff(OP_DELETE, "a"), Diff(OP_INSERT, "b"), Diff(OP_DELETE, "c"), Diff(OP_INSERT, "d"), Diff(OP_EQUAL, "e"), Diff(OP_EQUAL, "f"));
    dmp.diff_cleanupMerge(diffs);
    assertEquals("diff_cleanupMerge: Merge interweave.", diffList(Diff(OP_DELETE, "ac"), Diff(OP_INSERT, "bd"), Diff(OP_EQUAL, "ef")), diffs);

    diffs = diffList(Diff(OP_DELETE, "a"), Diff(OP_INSERT, "abc"), Diff(OP_DELETE, "dc"));
    dmp.diff_cleanupMerge(diffs);
    assertEquals("diff_cleanupMerge: Prefix and suffix detection.", diffList(Diff(OP_EQUAL, "a"), Diff(OP_DELETE, "d"), Diff(OP_INSERT, "b"), Diff(OP_EQUAL, "c")), diffs);

    diffs = diffList(Diff(OP_EQUAL, "x"), Diff(OP_DELETE, "a"), Diff(OP_INSERT, "abc"), Diff(OP_DELETE, "dc"), Diff(OP_EQUAL, "y"));
    dmp.diff_cleanupMerge(diffs);
    assertEquals("diff_cleanupMerge: Prefix and suffix detection with equalities.", diffList(Diff(OP_EQUAL, "xa"), Diff(OP_DELETE, "d"), Diff(OP_INSERT, "b"), Diff(OP_EQUAL, "cy")), diffs);

    diffs = diffList(Diff(OP_EQUAL, "a"), Diff(OP_INSERT, "ba"), Diff(OP_EQUAL, "c"));
    dmp.diff_cleanupMerge(diffs);
    assertEquals("diff_cleanupMerge: Slide edit left.", diffList(Diff(OP_INSERT, "ab"), Diff(OP_EQUAL, "ac")), diffs);

    diffs = diffList(Diff(OP_EQUAL, "c"), Diff(OP_INSERT, "ab"), Diff(OP_EQUAL, "a"));
    dmp.diff_cleanupMerge(diffs);
    assertEquals("diff_cleanupMerge: Slide edit right.", diffList(Diff(OP_EQUAL, "ca"), Diff(OP_INSERT, "ba")), diffs);

    diffs = diffList(Diff(OP_EQUAL, "a"), Diff(OP_DELETE, "b"), Diff(OP_EQUAL, "c"), Diff(OP_DELETE, "ac"), Diff(OP_EQUAL, "x"));
    dmp.diff_cleanupMerge(diffs);
    assertEquals("diff_cleanupMerge: Slide edit left recursive.", diffList(Diff(OP_DELETE, "abc"), Diff(OP_EQUAL, "acx")), diffs);

    diffs = diffList(Diff(OP_EQUAL, "x"), Diff(OP_DELETE, "ca"), Diff(OP_EQUAL, "c"), Diff(OP_DELETE, "b"), Diff(OP_EQUAL, "a"));
    dmp.diff_cleanupMerge(diffs);
    assertEquals("diff_cleanupMerge: Slide edit right recursive.", diffList(Diff(OP_EQUAL, "xca"), Diff(OP_DELETE, "cba")), diffs);
  }
  ...
  void testDiffCleanupSemanticLossless() {
    ...
    diffs = diffList(Diff(OP_EQUAL, "AAA\r\n\r\nBBB"), Diff(OP_INSERT, "\r\nDDD\r\n\r\nBBB"), Diff(OP_EQUAL, "\r\nEEE"));
    dmp.diff_cleanupSemanticLossless(diffs);
    assertEquals("diff_cleanupSemanticLossless: Blank lines.", diffList(Diff(OP_EQUAL, "AAA\r\n\r\n"), Diff(OP_INSERT, "BBB\r\nDDD\r\n\r\n"), Diff(OP_EQUAL, "BBB\r\nEEE")), diffs);

    diffs = diffList(Diff(OP_EQUAL, "AAA\r\nBBB"), Diff(OP_INSERT, " DDD\r\nBBB"), Diff(OP_EQUAL, " EEE"));
    dmp.diff_cleanupSemanticLossless(diffs);
    assertEquals("diff_cleanupSemanticLossless: Line boundaries.", diffList(Diff(OP_EQUAL, "AAA\r\n"), Diff(OP_INSERT, "BBB DDD\r\n"), Diff(OP_EQUAL, "BBB EEE")), diffs);

    diffs = diffList(Diff(OP_EQUAL, "The c"), Diff(OP_INSERT, "ow and the c"), Diff(OP_EQUAL, "at."));
    dmp.diff_cleanupSemanticLossless(diffs);
    assertEquals("diff_cleanupSemantic: Word boundaries.", diffList(Diff(OP_EQUAL, "The "), Diff(OP_INSERT, "cow and the "), Diff(OP_EQUAL, "cat.")), diffs);

    diffs = diffList(Diff(OP_EQUAL, "The-c"), Diff(OP_INSERT, "ow-and-the-c"), Diff(OP_EQUAL, "at."));
    dmp.diff_cleanupSemanticLossless(diffs);
    assertEquals("diff_cleanupSemantic: Alphanumeric boundaries.", diffList(Diff(OP_EQUAL, "The-"), Diff(OP_INSERT, "cow-and-the-"), Diff(OP_EQUAL, "cat.")), diffs);

    diffs = diffList(Diff(OP_EQUAL, "a"), Diff(OP_DELETE, "a"), Diff(OP_EQUAL, "ax"));
    dmp.diff_cleanupSemanticLossless(diffs);
    assertEquals("diff_cleanupSemantic: Hitting the start.", diffList(Diff(OP_DELETE, "a"), Diff(OP_EQUAL, "aax")), diffs);

    diffs = diffList(Diff(OP_EQUAL, "xa"), Diff(OP_DELETE, "a"), Diff(OP_EQUAL, "a"));
    dmp.diff_cleanupSemanticLossless(diffs);
    assertEquals("diff_cleanupSemantic: Hitting the end.", diffList(Diff(OP_EQUAL, "xaa"), Diff(OP_DELETE, "a")), diffs);

    diffs = diffList(Diff(OP_EQUAL, "The xxx. The "), Diff(OP_INSERT, "zzz. The "), Diff(OP_EQUAL, "yyy."));
    dmp.diff_cleanupSemanticLossless(diffs);
    assertEquals("diff_cleanupSemantic: Sentence boundaries.", diffList(Diff(OP_EQUAL, "The xxx."), Diff(OP_INSERT, " The zzz."), Diff(OP_EQUAL, " The yyy.")), diffs);
}
  ...
  void testDiffCleanupSemantic() {
    ...
    diffs = diffList(Diff(OP_DELETE, "ab"), Diff(OP_INSERT, "cd"), Diff(OP_EQUAL, "12"), Diff(OP_DELETE, "e"));
    dmp.diff_cleanupSemantic(diffs);
    assertEquals("diff_cleanupSemantic: No elimination #1.", diffList(Diff(OP_DELETE, "ab"), Diff(OP_INSERT, "cd"), Diff(OP_EQUAL, "12"), Diff(OP_DELETE, "e")), diffs);

    diffs = diffList(Diff(OP_DELETE, "abc"), Diff(OP_INSERT, "ABC"), Diff(OP_EQUAL, "1234"), Diff(OP_DELETE, "wxyz"));
    dmp.diff_cleanupSemantic(diffs);
    assertEquals("diff_cleanupSemantic: No elimination #2.", diffList(Diff(OP_DELETE, "abc"), Diff(OP_INSERT, "ABC"), Diff(OP_EQUAL, "1234"), Diff(OP_DELETE, "wxyz")), diffs);

    diffs = diffList(Diff(OP_DELETE, "a"), Diff(OP_EQUAL, "b"), Diff(OP_DELETE, "c"));
    dmp.diff_cleanupSemantic(diffs);
    assertEquals("diff_cleanupSemantic: Simple elimination.", diffList(Diff(OP_DELETE, "abc"), Diff(OP_INSERT, "b")), diffs);

    diffs = diffList(Diff(OP_DELETE, "ab"), Diff(OP_EQUAL, "cd"), Diff(OP_DELETE, "e"), Diff(OP_EQUAL, "f"), Diff(OP_INSERT, "g"));
    dmp.diff_cleanupSemantic(diffs);
    assertEquals("diff_cleanupSemantic: Backpass elimination.", diffList(Diff(OP_DELETE, "abcdef"), Diff(OP_INSERT, "cdfg")), diffs);

    diffs = diffList(Diff(OP_INSERT, "1"), Diff(OP_EQUAL, "A"), Diff(OP_DELETE, "B"), Diff(OP_INSERT, "2"), Diff(OP_EQUAL, "_"), Diff(OP_INSERT, "1"), Diff(OP_EQUAL, "A"), Diff(OP_DELETE, "B"), Diff(OP_INSERT, "2"));
    dmp.diff_cleanupSemantic(diffs);
    assertEquals("diff_cleanupSemantic: Multiple elimination.", diffList(Diff(OP_DELETE, "AB_AB"), Diff(OP_INSERT, "1A2_1A2")), diffs);

    diffs = diffList(Diff(OP_EQUAL, "The c"), Diff(OP_DELETE, "ow and the c"), Diff(OP_EQUAL, "at."));
    dmp.diff_cleanupSemantic(diffs);
    assertEquals("diff_cleanupSemantic: Word boundaries.", diffList(Diff(OP_EQUAL, "The "), Diff(OP_DELETE, "cow and the "), Diff(OP_EQUAL, "cat.")), diffs);

    diffs = diffList(Diff(OP_DELETE, "abcxx"), Diff(OP_INSERT, "xxdef"));
    dmp.diff_cleanupSemantic(diffs);
    assertEquals("diff_cleanupSemantic: No overlap elimination.", diffList(Diff(OP_DELETE, "abcxx"), Diff(OP_INSERT, "xxdef")), diffs);

    diffs = diffList(Diff(OP_DELETE, "abcxxx"), Diff(OP_INSERT, "xxxdef"));
    dmp.diff_cleanupSemantic(diffs);
    assertEquals("diff_cleanupSemantic: Overlap elimination.", diffList(Diff(OP_DELETE, "abc"), Diff(OP_EQUAL, "xxx"), Diff(OP_INSERT, "def")), diffs);

    diffs = diffList(Diff(OP_DELETE, "xxxabc"), Diff(OP_INSERT, "defxxx"));
    dmp.diff_cleanupSemantic(diffs);
    assertEquals("diff_cleanupSemantic: Reverse overlap elimination.", diffList(Diff(OP_INSERT, "def"), Diff(OP_EQUAL, "xxx"), Diff(OP_DELETE, "abc")), diffs);

    diffs = diffList(Diff(OP_DELETE, "abcd1212"), Diff(OP_INSERT, "1212efghi"), Diff(OP_EQUAL, "----"), Diff(OP_DELETE, "A3"), Diff(OP_INSERT, "3BC"));
    dmp.diff_cleanupSemantic(diffs);
    assertEquals("diff_cleanupSemantic: Two overlap eliminations.", diffList(Diff(OP_DELETE, "abcd"), Diff(OP_EQUAL, "1212"), Diff(OP_INSERT, "efghi"), Diff(OP_EQUAL, "----"), Diff(OP_DELETE, "A"), Diff(OP_EQUAL, "3"), Diff(OP_INSERT, "BC")), diffs);
  }
  ...
  void testDiffCleanupEfficiency() {
    ...
    diffs = diffList(Diff(OP_DELETE, "ab"), Diff(OP_INSERT, "12"), Diff(OP_EQUAL, "wxyz"), Diff(OP_DELETE, "cd"), Diff(OP_INSERT, "34"));
    dmp.diff_cleanupEfficiency(diffs);
    assertEquals("diff_cleanupEfficiency: No elimination.", diffList(Diff(OP_DELETE, "ab"), Diff(OP_INSERT, "12"), Diff(OP_EQUAL, "wxyz"), Diff(OP_DELETE, "cd"), Diff(OP_INSERT, "34")), diffs);

    diffs = diffList(Diff(OP_DELETE, "ab"), Diff(OP_INSERT, "12"), Diff(OP_EQUAL, "xyz"), Diff(OP_DELETE, "cd"), Diff(OP_INSERT, "34"));
    dmp.diff_cleanupEfficiency(diffs);
    assertEquals("diff_cleanupEfficiency: Four-edit elimination.", diffList(Diff(OP_DELETE, "abxyzcd"), Diff(OP_INSERT, "12xyz34")), diffs);

    diffs = diffList(Diff(OP_INSERT, "12"), Diff(OP_EQUAL, "x"), Diff(OP_DELETE, "cd"), Diff(OP_INSERT, "34"));
    dmp.diff_cleanupEfficiency(diffs);
    assertEquals("diff_cleanupEfficiency: Three-edit elimination.", diffList(Diff(OP_DELETE, "xcd"), Diff(OP_INSERT, "12x34")), diffs);

    diffs = diffList(Diff(OP_DELETE, "ab"), Diff(OP_INSERT, "12"), Diff(OP_EQUAL, "xy"), Diff(OP_INSERT, "34"), Diff(OP_EQUAL, "z"), Diff(OP_DELETE, "cd"), Diff(OP_INSERT, "56"));
    dmp.diff_cleanupEfficiency(diffs);
    assertEquals("diff_cleanupEfficiency: Backpass elimination.", diffList(Diff(OP_DELETE, "abxyzcd"), Diff(OP_INSERT, "12xy34z56")), diffs);

    dmp.Diff_EditCost = 5;
    diffs = diffList(Diff(OP_DELETE, "ab"), Diff(OP_INSERT, "12"), Diff(OP_EQUAL, "wxyz"), Diff(OP_DELETE, "cd"), Diff(OP_INSERT, "34"));
    dmp.diff_cleanupEfficiency(diffs);
    assertEquals("diff_cleanupEfficiency: High cost elimination.", diffList(Diff(OP_DELETE, "abwxyzcd"), Diff(OP_INSERT, "12wxyz34")), diffs);
    dmp.Diff_EditCost = 4;
  }

  void testDiffPrettyHtml() {
    // Pretty print.
    Diffs diffs = diffList(Diff(OP_EQUAL, "a\n"), Diff(OP_DELETE, "<B>b</B>"), Diff(OP_INSERT, "c&d"));
  ...
  void testDiffText() {
    ...
    Diffs diffs = diffList(Diff(OP_EQUAL, "jump"), Diff(OP_DELETE, "s"), Diff(OP_INSERT, "ed"), Diff(OP_EQUAL, " over "), Diff(OP_DELETE, "the"), Diff(OP_INSERT, "a"), Diff(OP_EQUAL, " lazy"));
  ...
  void testDiffDelta() {
    ...
    Diffs diffs = diffList(Diff(OP_EQUAL, "jump"), Diff(OP_DELETE, "s"), Diff(OP_INSERT, "ed"), Diff(OP_EQUAL, " over "), Diff(OP_DELETE, "the"), Diff(OP_INSERT, "a"), Diff(OP_EQUAL, " lazy"), Diff(OP_INSERT, "old dog"));
    ...
    diffs = diffList(Diff(OP_EQUAL, string_t(L"\u0680 \000 \t %", 7)), Diff(OP_DELETE, string_t(L"\u0681 \001 \n ^", 7)), Diff(OP_INSERT, string_t(L"\u0682 \002 \\ |", 7)));
    ...
    diffs = diffList(Diff(OP_INSERT, "A-Z a-z 0-9 - _ . ! ~ * ' ( ) ; / ? : @ & = + $ , # "));
  ...
  void testDiffXIndex() {
    ...
    Diffs diffs = diffList(Diff(OP_DELETE, "a"), Diff(OP_INSERT, "1234"), Diff(OP_EQUAL, "xyz"));
    assertEquals("diff_xIndex: Translation on equality.", 5, dmp.diff_xIndex(diffs, 2));

    diffs = diffList(Diff(OP_EQUAL, "a"), Diff(OP_DELETE, "1234"), Diff(OP_EQUAL, "xyz"));
    assertEquals("diff_xIndex: Translation on deletion.", 1, dmp.diff_xIndex(diffs, 3));
  }

  void testDiffLevenshtein() {
    Diffs diffs = diffList(Diff(OP_DELETE, "abc"), Diff(OP_INSERT, "1234"), Diff(OP_EQUAL, "xyz"));
    assertEquals("diff_levenshtein: Trailing equality.", 4, dmp.diff_levenshtein(diffs));

    diffs = diffList(Diff(OP_EQUAL, "xyz"), Diff(OP_DELETE, "abc"), Diff(OP_INSERT, "1234"));
    assertEquals("diff_levenshtein: Leading equality.", 4, dmp.diff_levenshtein(diffs));

    diffs = diffList(Diff(OP_DELETE, "abc"), Diff(OP_EQUAL, "xyz"), Diff(OP_INSERT, "1234"));
  ...
  void testDiffBisect() {
    ...
    Diffs diffs = diffList(Diff(OP_DELETE, "c"), Diff(OP_INSERT, "m"), Diff(OP_EQUAL, "a"), Diff(OP_DELETE, "t"), Diff(OP_INSERT, "p"));
    ...
    diffs = diffList(Diff(OP_DELETE, "cat"), Diff(OP_INSERT, "map"));
  ...
  void testDiffMain() {
    ...
    diffs = diffList(Diff(OP_EQUAL, "abc"));
    assertEquals("diff_main: Equality.", diffs, dmp.diff_main("abc", "abc", false));

    diffs = diffList(Diff(OP_EQUAL, "ab"), Diff(OP_INSERT, "123"), Diff(OP_EQUAL, "c"));
    assertEquals("diff_main: Simple insertion.", diffs, dmp.diff_main("abc", "ab123c", false));

    diffs = diffList(Diff(OP_EQUAL, "a"), Diff(OP_DELETE, "123"), Diff(OP_EQUAL, "bc"));
    assertEquals("diff_main: Simple deletion.", diffs, dmp.diff_main("a123bc", "abc", false));

    diffs = diffList(Diff(OP_EQUAL, "a"), Diff(OP_INSERT, "123"), Diff(OP_EQUAL, "b"), Diff(OP_INSERT, "456"), Diff(OP_EQUAL, "c"));
    assertEquals("diff_main: Two insertions.", diffs, dmp.diff_main("abc", "a123b456c", false));

    diffs = diffList(Diff(OP_EQUAL, "a"), Diff(OP_DELETE, "123"), Diff(OP_EQUAL, "b"), Diff(OP_DELETE, "456"), Diff(OP_EQUAL, "c"));
    assertEquals("diff_main: Two deletions.", diffs, dmp.diff_main("a123b456c", "abc", false));

    // Perform a real diff.
    // Switch off the timeout.
    dmp.Diff_Timeout = 0;
    diffs = diffList(Diff(OP_DELETE, "a"), Diff(OP_INSERT, "b"));
    assertEquals("diff_main: Simple case #1.", diffs, dmp.diff_main("a", "b", false));

    diffs = diffList(Diff(OP_DELETE, "Apple"), Diff(OP_INSERT, "Banana"), Diff(OP_EQUAL, "s are a"), Diff(OP_INSERT, "lso"), Diff(OP_EQUAL, " fruit."));
    assertEquals("diff_main: Simple case #2.", diffs, dmp.diff_main("Apples are a fruit.", "Bananas are also fruit.", false));

    diffs = diffList(Diff(OP_DELETE, "a"), Diff(OP_INSERT, L"\u0680"), Diff(OP_EQUAL, "x"), Diff(OP_DELETE, "\t"), Diff(OP_INSERT, string_t("\000", 1)));
    assertEquals("diff_main: Simple case #3.", diffs, dmp.diff_main("ax\t", string_t(L"\u0680x\000", 3), false));

    diffs = diffList(Diff(OP_DELETE, "1"), Diff(OP_EQUAL, "a"), Diff(OP_DELETE, "y"), Diff(OP_EQUAL, "b"), Diff(OP_DELETE, "2"), Diff(OP_INSERT, "xab"));
    assertEquals("diff_main: Overlap #1.", diffs, dmp.diff_main("1ayb2", "abxab", false));

    diffs = diffList(Diff(OP_INSERT, "xaxcx"), Diff(OP_EQUAL, "abc"), Diff(OP_DELETE, "y"));
    assertEquals("diff_main: Overlap #2.", diffs, dmp.diff_main("abcy", "xaxcxabc", false));

    diffs = diffList(Diff(OP_DELETE, "ABCD"), Diff(OP_EQUAL, "a"), Diff(OP_DELETE, "="), Diff(OP_INSERT, "-"), Diff(OP_EQUAL, "bcd"), Diff(OP_DELETE, "="), Diff(OP_INSERT, "-"), Diff(OP_EQUAL, "efghijklmnopqrs"), Diff(OP_DELETE, "EFGHIJKLMNOefg"));
    assertEquals("diff_main: Overlap #3.", diffs, dmp.diff_main("ABCDa=bcd=efghijklmnopqrsEFGHIJKLMNOefg", "a-bcd-efghijklmnopqrs", false));

    diffs = diffList(Diff(OP_INSERT, " "), Diff(OP_EQUAL, "a"), Diff(OP_INSERT, "nd"), Diff(OP_EQUAL, " [[Pennsylvania]]"), Diff(OP_DELETE, " and [[New"));
  ...
  void testPatchObj() {
    ...
    p.length1 = 18;
    p.length2 = 17;
    p.diffs = diffList(Diff(OP_EQUAL, "jump"), Diff(OP_DELETE, "s"), Diff(OP_INSERT, "ed"), Diff(OP_EQUAL, " over "), Diff(OP_DELETE, "the"), Diff(OP_INSERT, "a"), Diff(OP_EQUAL, "\nlaz"));
  ...
  void testPatchMake() {
    ...
    diffs = diffList(Diff(OP_DELETE, "`1234567890-=[]\\;',./"), Diff(OP_INSERT, "~!@#$%^&*()_+{}|:\"<>?"));
 ...
 private:
  ...
  static Strings diff_rebuildtexts(Diffs diffs) {
    ...
    for (Diffs::const_iterator myDiff = diffs.begin(); myDiff != diffs.end(); ++myDiff) {
      if ((*myDiff).operation != OP_INSERT) {
        *t0 += (*myDiff).text;
      }
      if ((*myDiff).operation != OP_DELETE) {
        *t1 += (*myDiff).text;
      }
    }
    return text;
  ...
  static Diffs diffList(
      ...
      Diff d1 = Diff(OP_INSERT, string_t()), Diff d2 = Diff(OP_INSERT, string_t()),
      Diff d3 = Diff(OP_INSERT, string_t()), Diff d4 = Diff(OP_INSERT, string_t()),
      Diff d5 = Diff(OP_INSERT, string_t()), Diff d6 = Diff(OP_INSERT, string_t()),
      Diff d7 = Diff(OP_INSERT, string_t()), Diff d8 = Diff(OP_INSERT, string_t()),
      Diff d9 = Diff(OP_INSERT, string_t()), Diff d10 = Diff(OP_INSERT, string_t())) {
    // Diff(INSERT, NULL) is invalid and thus is used as the default argument.
    Diffs listRet;
    if (d1.operation == OP_INSERT && d1.text.empty()) {
      return listRet;
    }
    listRet.push_back(d1);

    if (d2.operation == OP_INSERT && d2.text.empty()) {
      return listRet;
    }
    listRet.push_back(d2);

    if (d3.operation == OP_INSERT && d3.text.empty()) {
      return listRet;
    }
    listRet.push_back(d3);

    if (d4.operation == OP_INSERT && d4.text.empty()) {
      return listRet;
    }
    listRet.push_back(d4);

    if (d5.operation == OP_INSERT && d5.text.empty()) {
      return listRet;
    }
    listRet.push_back(d5);

    if (d6.operation == OP_INSERT && d6.text.empty()) {
      return listRet;
    }
    listRet.push_back(d6);

    if (d7.operation == OP_INSERT && d7.text.empty()) {
      return listRet;
    }
    listRet.push_back(d7);

    if (d8.operation == OP_INSERT && d8.text.empty()) {
      return listRet;
    }
    listRet.push_back(d8);

    if (d9.operation == OP_INSERT && d9.text.empty()) {
      return listRet;
    }
    listRet.push_back(d9);

    if (d10.operation == OP_INSERT && d10.text.empty()) {
      return listRet;
    }
