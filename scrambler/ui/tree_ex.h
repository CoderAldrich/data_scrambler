...
{  
	...
	// Construction  
public:  
	CTreeCtrlEx(CWnd *parent = NULL) : m_bSelectPending(FALSE), m_hClickedItem(NULL), m_hFirstSelectedItem(NULL), m_bSelectionComplete(TRUE), m_bEditLabelPending(FALSE) { m_parent = parent; }  
