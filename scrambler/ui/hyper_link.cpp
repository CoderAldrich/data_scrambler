...
BOOL CHyperLink::OnClicked()
{
    //int result = (int)GotoURL(m_strText, SW_SHOW);
...
void CHyperLink::PreSubclassWindow() 
{
    ...
    if (strWndText.IsEmpty()) {
        ASSERT(!m_strText.IsEmpty());    // Window and URL both NULL. DUH!
    ...
    m_ToolTip.AddTool(this, m_strText, rect, TOOLTIP_ID);
...
void CHyperLink::SetText(CString strURL)
{
    m_strText = strURL;
...
CString CHyperLink::GetText() const
{ 
    return m_strText;   
}
